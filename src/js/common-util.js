var CommonJS = {
     ...
     * 
     * CommonJS.scrollPaging(scrollPagingCallback);
     * 
     */
    scrollPaging: function(callback) {
...
CommonJS.DateTime = {
    ...
    timeToString: function (date) {
        ...
        _hour = CommonJS.Text.addZero(_hour);
        _minute = CommonJS.Text.addZero(_minute);
        _second = CommonJS.Text.addZero(_second);
    ...
    /**
     * 24시간 형식을 12시간 형식으로 반환
     * @param {String} time
     * @example
     * CommonJS.DateTime.convert24hto12h(time);
     */
    convert24hto12h: function(time) {
